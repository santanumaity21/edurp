(function () {
    'use strict';
           ...
           manageCourseController.$inject = ['$scope', '$q', '$log', 'manageCourseService', 'commonService', '$modal'];
    
           function manageCourseController($scope, $q, $log, manageCourseService, commonService, $modal) {
